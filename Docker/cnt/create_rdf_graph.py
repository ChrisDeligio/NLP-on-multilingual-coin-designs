...
"Optimizing a Natural Language Processing Pipeline for the automatic creation of RDF data" by Nils Dambowy.
...
def serialize_graph(g):
    ...
    g.serialize(destination="output.ttl", format="nt", encoding="utf-8")
